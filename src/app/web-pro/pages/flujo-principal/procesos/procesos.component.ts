  ...
  arrayProcesos: Flujo[] = [
    {
      ...
      description:
        'Se accede de manera similar a la planilla Mensual, solo que aquí podremos hacer modificaciones específicas',
    ...
    },
    {
      ...
      description:
        'Una vez encontradas las columnas a modificar, borramos el monto y colocamos el nuestro, procedemos a guardar',
      urlImage: 'assets/Flujo-principal/Procesos/3.modificar.png',
    },
    {
      title: 'Ingresar a planilla Mensual',
      description:
        'Salimos y ahora ingresamos a la planilla Mensual de siempre.',
      urlImage: 'assets/Flujo-principal/Procesos/4.mensual.png',
    },
    {
      title: 'Procesar',
      description:
        'Procesamos a los trabajadores que modificamos desde la planilla manual, es recomendable procesar individualmente.',
      urlImage: 'assets/Flujo-principal/Procesos/5.procesar.png',
    },
    {
      title: 'Regresar valor a la normalidad',
      description:
        'Este paso es opcional, si queremos regresar a su valor original, repetimos el procedimiento de ingresar a planilla Manual pero ahora en el campo a modificar colocamos 0 y guardamos. Posteriormente regresamos a Mensual y volvemos a procesar',
